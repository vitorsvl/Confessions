...
SCALES = {
        ...
        'gold': ['#FE8602', '#FE9401', '#FFA201', '#FFB100', '#FFBE17', '#FFD644', '#FFE05A', '#FFE971', '#FFF187', '#ffaa00', '#ffc800', '#ffbe33', '#ffaa0d'], 
        'rose': ['#FF2250','#FF446B','#FF6786','#FF89A1','#FFABBC', '#F0766D', '#FFA49C', '#FF9EBD', '#FF89AC', '#FF765E','#FF7F64','#FF8E74','#FFA48E', '#ff5ec1'],
        'violet': ['#5F0DB7','#740FCF','#8B10E7','#A511FF','#BF57FF','#CC79FF','#DA9CFF','#E7BFFF','#b127e8', '#9d4fb0'],
        'misc': [
                '#018777','#43d1b7','#019245','#01A857','#01BE6B','#00D482','#25EDA9','#4BF0B8','#70F3C6','#95F6D5','#BAF9E4', '#38d9ef', '#64ed98',
                '#FF2250','#FF6786','#FF89A1','#FFABBC', '#F0766D', '#FFA49C', '#FF9EBD', '#FF89AC', '#FF765E','#FF7F64','#FF8E74','#FFA48E', '#ff5ec1',
                '#082687','#0058BA','#1367C8','#2776D4','#3A84DF','#4E93E9','#74B0F8','#88BDFD','#9BCAFF','#AED6FF', '#C2E2FF', '#176ffc', '#4a6acf', '#389cff',
                '#5F0DB7','#740FCF','#8B10E7','#A511FF','#BF57FF','#CC79FF','#DA9CFF','#E7BFFF','#b127e8', '#9d4fb0',
                '#082687','#0058BA','#1367C8','#2776D4','#3A84DF','#4E93E9','#74B0F8','#88BDFD','#9BCAFF','#AED6FF', '#C2E2FF', '#176ffc', '#4a6acf'  
                ]
        }
